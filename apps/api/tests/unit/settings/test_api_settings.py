...
from boxbox_api.settings.api_settings import ApplicationSettings, ContactInfo, LicenseInfo
from boxbox_api.version import __version__
...
class TestAPISettings:
    ...
    def test_api_default_values(self):
        ...
        assert settings.PROJECT_NAME == "BoxBox API"
        assert settings.PROJECT_DESCRIPTION == "BoxBox backend API - F1 pit stop strategy advisor"
