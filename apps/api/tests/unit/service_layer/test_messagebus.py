...
from boxbox_api.domain.messages import Command, Event, Message
from boxbox_api.service_layer.messagebus import MessageBus, UnhandledCommand
...
class TestMessageBus:
    ...
    async def test_logs_event_handler_failures_and_continues(self):
        ...
        # WHEN
        with patch("boxbox_api.service_layer.messagebus.log.exception") as log_exception:
            result = await bus.handle(_SampleCommand(label="ok"))
