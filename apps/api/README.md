...
**BoxBox API** is a [FastAPI](https://fastapi.tiangolo.com/) service following the
...
| FASTAPI_PROJECT_NAME         | Swagger Title                               | BoxBox API                               |
| FASTAPI_PROJECT_DESCRIPTION  | Swagger Description                         | BoxBox backend API - F1 pit stop strategy advisor                         |
...
FASTAPI_PROJECT_CONTACT='{"name": "Tomas Sanchez", "url": "https://tomsanchez.com", "email": "info@tomsanchez.com"}'
```
...
| Name                        | Description                              | Default Value                          |
|-----------------------------|------------------------------------------|----------------------------------------|
| DATABASE_URL                | SQLAlchemy database URL                  | postgresql+asyncpg://boxbox-api:boxbox-api@localhost:5432/boxbox-api |
...
1. Clone the repository
    ...
    ```bash
    git clone "git@github.com:tomasanchez/boxbox-api.git"
    ```
2. Install dependencies

    ```bash
    cd boxbox-api && uv sync --dev
    ```
...
2. Run:
    ...
    ```bash
    uv run python -m boxbox_api.main
    ```
...
This project was generated by [Tomas Sanchez](https://tomsanchez.com) <[info@tomsanchez.com](mailto:info@tomsanchez.com)>.

Generated from the [Cosmic FastAPI](https://github.com/tomasanchez/cosmic-fastapi) template,
created by [Tomás Sánchez](https://tomsanchez.com.ar/about/).
