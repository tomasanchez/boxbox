...
class ApplicationSettings(BaseSettings):
    ...
    DEBUG: bool = False
    PROJECT_NAME: str = "BoxBox API"
    PROJECT_DESCRIPTION: str = "BoxBox backend API - F1 pit stop strategy advisor"
    ...
    PROJECT_CONTACT: ContactInfo | None = ContactInfo(
        name="Tomas Sanchez", url="https://tomsanchez.com", email="info@tomsanchez.com"
    )
